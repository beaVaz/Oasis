        ...
        <View style={StyleOfVestibular.background}>
            <View style={StyleOfVestibular.header}>
                ...
                <View style={StyleOfVestibular.headerTitle}>
                    <Text style={{fontFamily:'Poppins_Bold', color:'#fff', fontSize:20}}>USP</Text>
                    <Text style={{fontFamily:'Poppins_Regular', color:'#fff', fontSize:15}}>-Universidade de São Paulo</Text>
                </View>
            </View>
            <ScrollView 
            ...
            >
                <View style={StyleOfVestibular.container}>
                    ...
                    />
                    <Text style={StyleOfVestibular.mainTitle}>USP</Text>
                    <Text style={StyleOfVestibular.subtitle}>Médio</Text>
                </View>

                <View style={StyleOfVestibular.container}>
                    <Text style={StyleOfVestibular.mainTitle}>Vestibular do USP</Text>

                    <Text style={StyleOfVestibular.paragraph}>
                        E aí, futuro(a) universitário(a)?  é o caminho para a faculdade dos sonhos, 
