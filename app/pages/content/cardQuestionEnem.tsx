    ...
    setTimeout(() => {
      ...
      if (currentQuestion + 1 < questions.length) {
        ...
        Alert.alert(
          ...
          [{ text: "OK", onPress: () => router.push("/pages/main/pagesRoot/studyPlanEnem") }]
        );
      }
    }, 1000);
  };
  ...
  return (
    <View style={localStyles.quizContainer}>
      <View style={localStyles.headerBack}>
        <Pressable onPress={() => router.push('/pages/main/pagesRoot/studyPlanEnem')}>
          <Link href={'/pages/main/pagesRoot/studyPlanEnem'}>
